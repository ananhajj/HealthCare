...
<div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30 transition-all duration-300">
    ...
    <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
      {workHours.length > 0 ? (
        workHours.map((day, index) => (
          <div
            key={day.id}
            className={`flex flex-col items-start justify-between p-4 rounded-lg transition-all duration-300 ${
              day.active
  ...
  <div className="flex flex-col">
    ...
    <input
      ...
      disabled={!day.active}
      className={`p-2 border rounded-md text-gray-700 dark:text-gray-100 focus:outline-none focus:ring-2 ${
        day.active
